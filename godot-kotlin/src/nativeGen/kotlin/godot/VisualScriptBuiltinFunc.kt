...
open class VisualScriptBuiltinFunc(
  ...
  fun getFunc(): BuiltinFunc {
    ...
    return Allocator.allocationScope {
      ...
      __method_bind.getFunc.call(self._handle, emptyList(), _retPtr)
      VisualScriptBuiltinFunc.BuiltinFunc.from(_ret.value)
    }
  }
  ...
  fun setFunc(which: Int) {
    val self = this
    return Allocator.allocationScope {
      __method_bind.setFunc.call(self._handle, listOf(which), null)
    }
  }
