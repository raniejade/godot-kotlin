...
open class AnimatedTexture(
  ...
  fun getFps(): Float {
    ...
    return Allocator.allocationScope {
      ...
      __method_bind.getFps.call(self._handle, emptyList(), _retPtr)
      _ret.value.toFloat()
    }
  }
  ...
  fun getFrameDelay(frame: Int): Float {
    ...
    return Allocator.allocationScope {
      val _ret = alloc<DoubleVar>()
      val _retPtr = _ret.ptr
      __method_bind.getFrameDelay.call(self._handle, listOf(frame), _retPtr)
      _ret.value.toFloat()
    }
  }
  ...
  fun getFrameTexture(frame: Int): Texture {
    ...
    return Allocator.allocationScope {
      ...
      __method_bind.getFrameTexture.call(self._handle, listOf(frame), _retPtr)
  ...
  fun getFrames(): Int {
    ...
    return Allocator.allocationScope {
      ...
      val _retPtr = _ret.ptr
      __method_bind.getFrames.call(self._handle, emptyList(), _retPtr)
      _ret.value
    }
  }
  ...
  fun setFps(fps: Float) {
    val self = this
    return Allocator.allocationScope {
      __method_bind.setFps.call(self._handle, listOf(fps), null)
    }
  }
  ...
  fun setFrameDelay(frame: Int, delay: Float) {
    ...
    return Allocator.allocationScope {
      ...
      _args.add(frame)
      _args.add(delay)
      __method_bind.setFrameDelay.call(self._handle, _args, null)
    }
  }
  ...
  fun setFrameTexture(frame: Int, texture: Texture) {
    ...
    return Allocator.allocationScope {
      ...
      _args.add(frame)
      _args.add(texture)
      __method_bind.setFrameTexture.call(self._handle, _args, null)
    }
  }
  ...
  fun setFrames(frames: Int) {
    val self = this
    return Allocator.allocationScope {
      __method_bind.setFrames.call(self._handle, listOf(frames), null)
    }
  }
  ...
  companion object {
    ...
    private object __method_bind {
      val getFps: CPointer<godot_method_bind> by lazy {
      ...
      val getFrameDelay: CPointer<godot_method_bind> by lazy {
            Allocator.allocationScope {
              val ptr =
              checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AnimatedTexture".cstr.ptr,
      ...
      val getFrameTexture: CPointer<godot_method_bind> by lazy {
            Allocator.allocationScope {
              val ptr =
              checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AnimatedTexture".cstr.ptr,
      ...
      val getFrames: CPointer<godot_method_bind> by lazy {
            Allocator.allocationScope {
              val ptr =
              checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AnimatedTexture".cstr.ptr,
              "get_frames".cstr.ptr)
      ...
      val setFps: CPointer<godot_method_bind> by lazy {
            Allocator.allocationScope {
              val ptr =
              checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AnimatedTexture".cstr.ptr,
              "set_fps".cstr.ptr)
      ...
      val setFrameDelay: CPointer<godot_method_bind> by lazy {
            Allocator.allocationScope {
              val ptr =
              checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AnimatedTexture".cstr.ptr,
      ...
      val setFrameTexture: CPointer<godot_method_bind> by lazy {
            Allocator.allocationScope {
              val ptr =
              checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AnimatedTexture".cstr.ptr,
      ...
      val setFrames: CPointer<godot_method_bind> by lazy {
            Allocator.allocationScope {
              val ptr =
              checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AnimatedTexture".cstr.ptr,
              "set_frames".cstr.ptr)
