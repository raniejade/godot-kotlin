...
open class VisualScriptPreload(
  ...
  fun getPreload(): Resource {
    ...
    return Allocator.allocationScope {
      ...
      __method_bind.getPreload.call(self._handle, emptyList(), _retPtr)
  ...
  fun setPreload(resource: Resource) {
    val self = this
    return Allocator.allocationScope {
      __method_bind.setPreload.call(self._handle, listOf(resource), null)
    }
  }
  ...
  companion object {
    ...
    private object __method_bind {
      val getPreload: CPointer<godot_method_bind> by lazy {
      ...
      val setPreload: CPointer<godot_method_bind> by lazy {
            Allocator.allocationScope {
              val ptr =
              checkNotNull(Godot.gdnative.godot_method_bind_get_method)("VisualScriptPreload".cstr.ptr,
