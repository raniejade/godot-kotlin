...
open class LightOccluder2D(
  ...
  fun getOccluderPolygon(): OccluderPolygon2D {
    ...
    return Allocator.allocationScope {
      ...
      __method_bind.getOccluderPolygon.call(self._handle, emptyList(), _retPtr)
  ...
  fun setOccluderPolygon(polygon: OccluderPolygon2D) {
    val self = this
    return Allocator.allocationScope {
      __method_bind.setOccluderPolygon.call(self._handle, listOf(polygon), null)
    }
  }
  ...
  companion object {
    ...
    private object __method_bind {
      ...
      val getOccluderPolygon: CPointer<godot_method_bind> by lazy {
            Allocator.allocationScope {
              val ptr =
              checkNotNull(Godot.gdnative.godot_method_bind_get_method)("LightOccluder2D".cstr.ptr,
      ...
      val setOccluderPolygon: CPointer<godot_method_bind> by lazy {
            Allocator.allocationScope {
              val ptr =
              checkNotNull(Godot.gdnative.godot_method_bind_get_method)("LightOccluder2D".cstr.ptr,
