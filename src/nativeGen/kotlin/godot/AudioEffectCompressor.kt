...
open class AudioEffectCompressor(
  ...
  fun getAttackUs(): Float {
    val _ret = __method_bind.get_attack_us.call(this._handle)
    return _ret.asFloat()
  }
  ...
  fun getMix(): Float {
    val _ret = __method_bind.get_mix.call(this._handle)
    return _ret.asFloat()
  }

  fun getRatio(): Float {
    val _ret = __method_bind.get_ratio.call(this._handle)
    return _ret.asFloat()
  }

  fun getReleaseMs(): Float {
    val _ret = __method_bind.get_release_ms.call(this._handle)
    return _ret.asFloat()
  }

  fun getSidechain(): String {
    val _ret = __method_bind.get_sidechain.call(this._handle)
    return _ret.asString()
  }

  fun getThreshold(): Float {
    val _ret = __method_bind.get_threshold.call(this._handle)
    return _ret.asFloat()
  }

  fun setAttackUs(attackUs: Float) {
    val _arg = Variant.new(attackUs)
    __method_bind.set_attack_us.call(this._handle, _arg, 1)
  }
  ...
  fun setMix(mix: Float) {
    ...
    __method_bind.set_mix.call(this._handle, _arg, 1)
  }

  fun setRatio(ratio: Float) {
    val _arg = Variant.new(ratio)
    __method_bind.set_ratio.call(this._handle, _arg, 1)
  }

  fun setReleaseMs(releaseMs: Float) {
    val _arg = Variant.new(releaseMs)
    __method_bind.set_release_ms.call(this._handle, _arg, 1)
  }

  fun setSidechain(sidechain: String) {
    val _arg = Variant.new(sidechain)
    __method_bind.set_sidechain.call(this._handle, _arg, 1)
  }

  fun setThreshold(threshold: Float) {
    val _arg = Variant.new(threshold)
    __method_bind.set_threshold.call(this._handle, _arg, 1)
  }
  ...
  companion object {
    ...
    private object __method_bind {
      val get_attack_us: CPointer<godot_method_bind>
        get() = memScoped {
          val ptr =
      ...
      val get_mix: CPointer<godot_method_bind>
        get() = memScoped {
          val ptr =
            checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AudioEffectCompressor".cstr.ptr,
            "get_mix".cstr.ptr)
      ...
      val get_ratio: CPointer<godot_method_bind>
        get() = memScoped {
          val ptr =
            checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AudioEffectCompressor".cstr.ptr,
            "get_ratio".cstr.ptr)
      ...
      val get_release_ms: CPointer<godot_method_bind>
        get() = memScoped {
          val ptr =
            checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AudioEffectCompressor".cstr.ptr,
      ...
      val get_sidechain: CPointer<godot_method_bind>
        get() = memScoped {
          val ptr =
            checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AudioEffectCompressor".cstr.ptr,
      ...
      val get_threshold: CPointer<godot_method_bind>
        get() = memScoped {
          val ptr =
            checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AudioEffectCompressor".cstr.ptr,
      ...
      val set_attack_us: CPointer<godot_method_bind>
        get() = memScoped {
          val ptr =
            checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AudioEffectCompressor".cstr.ptr,
      ...
      val set_mix: CPointer<godot_method_bind>
        get() = memScoped {
          val ptr =
            checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AudioEffectCompressor".cstr.ptr,
            "set_mix".cstr.ptr)
      ...
      val set_ratio: CPointer<godot_method_bind>
        get() = memScoped {
          val ptr =
            checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AudioEffectCompressor".cstr.ptr,
            "set_ratio".cstr.ptr)
      ...
      val set_release_ms: CPointer<godot_method_bind>
        get() = memScoped {
          val ptr =
            checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AudioEffectCompressor".cstr.ptr,
      ...
      val set_sidechain: CPointer<godot_method_bind>
        get() = memScoped {
          val ptr =
            checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AudioEffectCompressor".cstr.ptr,
      ...
      val set_threshold: CPointer<godot_method_bind>
        get() = memScoped {
          val ptr =
            checkNotNull(Godot.gdnative.godot_method_bind_get_method)("AudioEffectCompressor".cstr.ptr,
