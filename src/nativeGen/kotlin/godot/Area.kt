...
open class Area(
  ...
  fun getAudioBus(): String {
    val _ret = __method_bind.get_audio_bus.call(this._handle)
  ...
  fun getReverbAmount(): Float {
    val _ret = __method_bind.get_reverb_amount.call(this._handle)
    return _ret.asFloat()
  }

  fun getReverbBus(): String {
    val _ret = __method_bind.get_reverb_bus.call(this._handle)
    return _ret.asString()
  }

  fun getReverbUniformity(): Float {
    val _ret = __method_bind.get_reverb_uniformity.call(this._handle)
    return _ret.asFloat()
  }
  ...
  fun isUsingReverbBus(): Boolean {
    val _ret = __method_bind.is_using_reverb_bus.call(this._handle)
    return _ret.asBoolean()
  }
  ...
  fun setAudioBus(name: String) {
    ...
    __method_bind.set_audio_bus.call(this._handle, _arg, 1)
  }
  ...
  fun setReverbAmount(amount: Float) {
    ...
    __method_bind.set_reverb_amount.call(this._handle, _arg, 1)
  }

  fun setReverbBus(name: String) {
    val _arg = Variant.new(name)
    __method_bind.set_reverb_bus.call(this._handle, _arg, 1)
  }

  fun setReverbUniformity(amount: Float) {
    val _arg = Variant.new(amount)
    __method_bind.set_reverb_uniformity.call(this._handle, _arg, 1)
  }
  ...
  fun setUseReverbBus(enable: Boolean) {
    val _arg = Variant.new(enable)
    __method_bind.set_use_reverb_bus.call(this._handle, _arg, 1)
  }
