...
open class SkeletonIK(
  ...
  fun getInterpolation(): Float {
    val _ret = __method_bind.get_interpolation.call(this._handle)
    return _ret.asFloat()
  }

  fun getMagnetPosition(): Vector3 {
    val _ret = __method_bind.get_magnet_position.call(this._handle)
    return _ret.asVector3()
  }

  fun getMaxIterations(): Int {
    val _ret = __method_bind.get_max_iterations.call(this._handle)
    return _ret.asInt()
  }

  fun getMinDistance(): Float {
    val _ret = __method_bind.get_min_distance.call(this._handle)
    return _ret.asFloat()
  }

  fun getParentSkeleton(): Skeleton {
    val _ret = __method_bind.get_parent_skeleton.call(this._handle)
    return _ret.asObject(::Skeleton)!!
  }

  fun getRootBone(): String {
    val _ret = __method_bind.get_root_bone.call(this._handle)
    return _ret.asString()
  }

  fun getTargetNode(): NodePath {
    val _ret = __method_bind.get_target_node.call(this._handle)
    return _ret.asNodePath()
  }

  fun getTargetTransform(): Transform {
    val _ret = __method_bind.get_target_transform.call(this._handle)
    return _ret.asTransform()
  }

  fun getTipBone(): String {
    val _ret = __method_bind.get_tip_bone.call(this._handle)
    return _ret.asString()
  }
  ...
  fun setInterpolation(interpolation: Float) {
    ...
    __method_bind.set_interpolation.call(this._handle, _arg, 1)
  }

  fun setMagnetPosition(localPosition: Vector3) {
    val _arg = Variant.new(localPosition)
    __method_bind.set_magnet_position.call(this._handle, _arg, 1)
  }

  fun setMaxIterations(iterations: Int) {
    val _arg = Variant.new(iterations)
    __method_bind.set_max_iterations.call(this._handle, _arg, 1)
  }

  fun setMinDistance(minDistance: Float) {
    val _arg = Variant.new(minDistance)
    __method_bind.set_min_distance.call(this._handle, _arg, 1)
  }

  fun setOverrideTipBasis(override: Boolean) {
    val _arg = Variant.new(override)
    __method_bind.set_override_tip_basis.call(this._handle, _arg, 1)
  }

  fun setRootBone(rootBone: String) {
    val _arg = Variant.new(rootBone)
    __method_bind.set_root_bone.call(this._handle, _arg, 1)
  }

  fun setTargetNode(node: NodePath) {
    val _arg = Variant.new(node)
    __method_bind.set_target_node.call(this._handle, _arg, 1)
  }

  fun setTargetTransform(target: Transform) {
    val _arg = Variant.new(target)
    __method_bind.set_target_transform.call(this._handle, _arg, 1)
  }

  fun setTipBone(tipBone: String) {
    val _arg = Variant.new(tipBone)
    __method_bind.set_tip_bone.call(this._handle, _arg, 1)
  }

  fun setUseMagnet(use: Boolean) {
    val _arg = Variant.new(use)
    __method_bind.set_use_magnet.call(this._handle, _arg, 1)
  }
